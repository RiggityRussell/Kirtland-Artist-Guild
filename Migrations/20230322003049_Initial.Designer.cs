...
namespace Kirtland_Artist_Guild.Migrations
{
    ...
    [Migration("20230322003049_Initial")]
            ...
            modelBuilder.Entity("Kirtland_Artist_Guild.Models.Art", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Available = true,
                            Created = new DateTime(2023, 3, 21, 20, 30, 48, 854, DateTimeKind.Local).AddTicks(3636),
                        ...
                        new
                        {
                            ID = 2,
                            Available = true,
                            Created = new DateTime(2023, 3, 21, 20, 30, 48, 854, DateTimeKind.Local).AddTicks(3674),
                            Description = "Neat photo",
                            Name = "Poker Dogs",
